...
def test_dump_metadata_from_charmcraft_yaml(create_config, tmp_path):
...
def test_copy_metadata_from_metadata_yaml(create_config, tmp_path):
...
def test_dump_actions_from_charmcraft_yaml(create_config, tmp_path):
...
def test_copy_actions_from_actions_yaml(create_config, tmp_path):
    """Dump a actions.yaml from charmcraft.yaml."""
    create_config(
        {
...
def test_dump_config_from_charmcraft_yaml(create_config, tmp_path):
...
def test_copy_config_from_config_yaml(create_config, tmp_path):
    """Dump a actions.yaml from charmcraft.yaml."""
    create_config(
        {
            "charmcraft.yaml_ext": dedent(
