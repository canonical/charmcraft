...
.. important::
    ...
    :doc:`file-actions-yaml`, :doc:`file-config-yaml`, and :doc:`file-metadata-yaml`,
...
The value of this key is the contents of :doc:`file-actions-yaml`.
...
.. _file-charmcraft-yaml-links-contact:
.. _file-charmcraft-yaml-links-source:
.. _file-charmcraft-yaml-links-issues:
.. _file-charmcraft-yaml-links-website:
.. _file-charmcraft-yaml-contact:
.. _file-charmcraft-yaml-documentation:
...
.. _file-charmcraft-yaml-peers:
.. _file-charmcraft-yaml-provides:
.. _file-charmcraft-yaml-requires:
...
**Status:** Required if the :ref:`file-charmcraft-yaml-type` key is set to ``charm``.
