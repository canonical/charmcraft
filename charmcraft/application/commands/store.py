...
class PublishLibCommand(CharmcraftCommand):
    ...
    overview = textwrap.dedent(
        """
        Publish Charmhub-hosted charm libraries.
...
class FetchLibCommand(CharmcraftCommand):
    ...
    overview = textwrap.dedent(
        """
        Fetch Charmhub-hosted charm libraries.
...
class FetchLibs(CharmcraftCommand):
    ...
    overview = textwrap.dedent(
        """
        Fetch Charmhub-hosted charm libraries as listed in charmcraft.yaml.
...
class ListLibCommand(CharmcraftCommand):
    ...
    overview = textwrap.dedent(
        """
        List all Charmhub-hosted libraries from a charm.
