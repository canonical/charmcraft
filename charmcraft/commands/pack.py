...
For the bundle you must already have the `bundle.yaml` (can be
generated by Juju) and the README.md file.
"""
...
class PackCommand(BaseCommand):
    ...
    If charmcraft.yaml missing or indicates a charm, use the "build"
    infrastructure to build the charm.
