...
The following issues have been resolved in Charmcraft 4.3.2:

- `#2753 <https://github.com/canonical/charmcraft/pull/2753>`__ update urls and
  doc string in kubernetes and machine profiles.
