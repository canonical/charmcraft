...
.. note::
    ...
    When you run the command for the first time, you will get a warning about
    unapplied migrations.
    You can ignore this warning for now, as we are currently not performing any
    database operations. We will set up a database in a later section.
