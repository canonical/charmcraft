...
class _GunicornBase(Extension):
    ...
    def framework(self) -> str:
        """Return the name of the WSGI framework."""
    ...
    def check_input(self) -> None:
        ...
        for config in self._get_nested(self.yaml_data, "config.options"):
            for reserved_config_prefix in ("webserver-", f"{self.framework}-"):
                if config[: len(reserved_config_prefix)] == reserved_config_prefix:
                    raise ExtensionError(
    ...
    def _get_root_snippet(self) -> dict[str, Any]:
        ...
        return {
            ...
            "actions": self._ACTIONS[self.framework],
            "requires": {
            ...
            "config": {"options": {**self._WEBSERVER_OPTIONS, **self._OPTIONS[self.framework]}},
        }
...
class FlaskFramework(_GunicornBase):
    ...
    @override
    def framework(self) -> str:
        """Return the name of the Flask framework."""
        return "flask"
...
class DjangoFramework(_GunicornBase):
    ...
    @override
    def framework(self) -> str:
        """Return the name of the Django framework."""
        return "django"
