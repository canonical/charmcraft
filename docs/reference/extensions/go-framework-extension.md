(go-framework-extention)=

# Go framework extension

The `go-framework` extension includes configuration options customised for a Go application. This document describes all the keys that a user may interact with.
