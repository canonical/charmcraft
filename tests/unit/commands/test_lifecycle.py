...
def test_pack_update_charm_libs_empty(
    ...
    libs_service.write = mock.Mock(wraps=libs_service.write)  # ty:ignore[invalid-assignment]

    pack._update_charm_libs()

    libs_service.write.assert_called_once_with(store_lib)  # ty:ignore[unresolved-attribute]
