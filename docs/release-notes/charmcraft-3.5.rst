...
The `JSON Schema Store <https://schemastore.org>`_ now includes a schema for the :ref:`charmcraft-yaml-file`. If your text editor supports getting JSON schemas from
the schema store, they may already be visible in your text editor.
